...
$liebiao='https://www.nkvob.com/vodtype/{typeid}-{pageid}/';
//每页多少个影片
$num=72;
//=====================苹果CMS通用模板修改以上内容即可=============================
...
//影视更新情况 例如：更新至*集
$query2 = "//div[contains(@class,'module-item-cover')]/div[@class='module-item-caption right']";
...
//=====================苹果CMS通用模板修改以下内容即可=============================
//影片链接 {vodid}=影片ID 
$detail='https://www.nkvob.com/voddetail/{vodid}/';
//=====================苹果CMS通用模板修改以上内容即可=============================
...
//影片类型
$vodtype="//div[@class='tag-link']/a";

//取出影片图片 猫的详情图片显示在历史记录里（历史记录图片没有的话，就是这个没取对）
$vodimg="//div[@class='video-cover']//img/@data-src";

//取出影片简介
$vodtext="//div[@class='video-info-item video-info-content']//p[2]/text()";
